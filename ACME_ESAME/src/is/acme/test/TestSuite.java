...
public class TestSuite {
	...
	public void test2() {
		...
		try {
			...
			Report oracolo = new Report(gClienti.getListaClienti().get(0), 2, 11.35f);
			
			assertEquals(oracolo, report.get(0)); 
	...
	public void test3() {
		...
		try {
			...
			Report oracolo = new Report(gClienti.getListaClienti().get(0), 1, 7.96f);
